...
author: "Team Name: Ben, Jamie, Adam, Yara, Gigi"
date: "`r Sys.Date()`"
...
mutate (plastic_data_all, total_mismanaged_plastic = mismanaged_plastic*population) %>%
group_by(region) %>%
summarise(plastic_mean = mean(total_mismanaged_plastic))
...
```{r Ex3, message = FALSE}
mutate(pct_mismanaged_plastic_ocean, plastic_data_all = ()
